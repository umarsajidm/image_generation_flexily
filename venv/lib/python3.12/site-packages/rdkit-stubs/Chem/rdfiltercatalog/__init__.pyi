...
class FilterCatalogEntry(Boost.Python.instance):
    ...
    def ClearProp(self, key: typing.Any) -> None:
        """
            C++ signature :
                void ClearProp(RDKit::FilterCatalogEntry {lvalue},std::basic_string_view<char, std::char_traits<char> >)
        """
    ...
    def GetProp(self, key: typing.Any) -> str:
        """
            C++ signature :
                std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> > GetProp(RDKit::FilterCatalogEntry {lvalue},std::basic_string_view<char, std::char_traits<char> >)
        """
    ...
    def SetProp(self, key: typing.Any, val: str) -> None:
        """
            C++ signature :
                void SetProp(RDKit::FilterCatalogEntry {lvalue},std::basic_string_view<char, std::char_traits<char> >,std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >)
        """
    @typing.overload
    def __init__(self) -> None:
        """
