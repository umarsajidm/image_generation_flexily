...
def MolToChemDrawBlock(mol: Mol, format: CDXFormat = ...) -> str:
    """
        ...
        C++ signature :
            std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> > MolToChemDrawBlock(RDKit::ROMol [,RDKit::v2::CDXFormat=rdkit.Chem.rdChemDraw.CDXFormat.CDXML])
    """
def MolsFromChemDrawBlock(block: str, sanitize: bool = True, removeHs: bool = True) -> typing.Any:
    """
        ...
        C++ signature :
            boost::python::api::object MolsFromChemDrawBlock(std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> > [,bool=True [,bool=True]])
    """
